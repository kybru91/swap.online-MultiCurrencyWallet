...
- **Wallet Apps** - 6 integrated dApps in iframe with EIP-1193 bridge (auto-connect, no modal). Catalog: Swap.Online Exchange (internal), Onout DEX, PolyFactory, FarmFactory, IDO Launchpad, Crypto Lottery. Card screenshots in `src/front/shared/pages/Apps/images/`. Bridge client loaded from swaponline.github.io.
